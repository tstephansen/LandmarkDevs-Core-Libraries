...
{
    /// <summary>
    ///     This class is based on the DelegateCommandBase class from the Prism Library. https://github.com/PrismLibrary/Prism/blob/Prismv6.1.0/Source/Prism/Commands/DelegateCommandBase.cs
    /// </summary>
    ...
    public abstract class AsyncCommandBase : ICommand
    {
        ...
        ///     cref="Action{Object}" /> supplied during construction.
        /// </summary>
        ...
        /// <summary>
        ///     Determines if the command can execute with the provided parameter by invoking the
        ///     <see cref="Func{Object,Bool}" /> supplied during construction.
        /// </summary>
